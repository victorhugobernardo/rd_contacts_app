...
class CustomFieldsControllerTest < ActionController::TestCase
  ...
  test "should create custom_field" do
    assert_difference('CustomField.count') do
      post :create, custom_field: { field: @custom_field.field, field_type: @custom_field.field_type, usr_id: @custom_field.usr_id }
    end
  ...
  test "should update custom_field" do
    patch :update, id: @custom_field, custom_field: { field: @custom_field.field, field_type: @custom_field.field_type, usr_id: @custom_field.usr_id }
    assert_redirected_to custom_field_path(assigns(:custom_field))
  end
